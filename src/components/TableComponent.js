...
const TableComponent = () => {
  ...
  return (
    <>
      <div className="flex flex-col mt-9 border border-gray-100 rounded">
        {cryptoData ? (
          <table className="w-full table-auto">
            <thead
              className="capitalize text-base text-gray-100 font-medium border-b border-gray-100 
            "
            >
              <tr>
                <th className="py-1">asset</th>
                <th className="py-1 xs:table-cell hidden">name</th>
            ...
            hover:bg-gray-200 last:border-b-0"
                  >
                    ...
                    <td className="py-4 xs:table-cell hidden">
                      <Link to={`/${data.id}`} className="cursor-pointer ">
                        {data.name}
                      </Link>
                    </td>
      ...
      <div className="flex md:flex-row flex-col-reverse items-center justify-between   mt-4 capitalize  ">
        <span>
          Data provided by{" "}
          <a
            className="text-cyan"
